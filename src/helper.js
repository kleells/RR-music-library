// with_suspense: helper.js created to write a method that wraps the return of our API call and emits a status to inform Suspense where in the life cycle our data is

// relocate the behavior from useEffect into the file
...
// with_suspense: a "wrapper" function to emit a specific status
